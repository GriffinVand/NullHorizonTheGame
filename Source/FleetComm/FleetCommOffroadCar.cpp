...
#include "FleetCommOffroadCar.h"
#include "FleetCommOffroadWheelFront.h"
#include "FleetCommOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AFleetCommOffroadCar::AFleetCommOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFleetCommOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFleetCommOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFleetCommOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFleetCommOffroadWheelRear::StaticClass();
