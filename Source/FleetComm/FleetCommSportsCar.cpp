...
#include "FleetCommSportsCar.h"
#include "FleetCommSportsWheelFront.h"
#include "FleetCommSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AFleetCommSportsCar::AFleetCommSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFleetCommSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFleetCommSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFleetCommSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFleetCommSportsWheelRear::StaticClass();
